...
void ABP_PlayerController_cLeon_C::InpActEvt_Gamepad_Special_Left_K2Node_InputKeyEvent_1(const struct FKey& Key)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PlayerController_cLeon_C", "InpActEvt_Gamepad_Special_Left_K2Node_InputKeyEvent_1");

	Params::BP_PlayerController_cLeon_C_InpActEvt_Gamepad_Special_Left_K2Node_InputKeyEvent_1 Parms{};
...
// Function BP_PlayerController_cLeon.BP_PlayerController_cLeon_C.InpActEvt_Gamepad_Special_Left_K2Node_InputKeyEvent_0
// (BlueprintEvent)
// Parameters:
// const struct FKey&                      Key                                                    (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)

void ABP_PlayerController_cLeon_C::InpActEvt_Gamepad_Special_Left_K2Node_InputKeyEvent_0(const struct FKey& Key)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PlayerController_cLeon_C", "InpActEvt_Gamepad_Special_Left_K2Node_InputKeyEvent_0");

	Params::BP_PlayerController_cLeon_C_InpActEvt_Gamepad_Special_Left_K2Node_InputKeyEvent_0 Parms{};
...
// Function BP_PlayerController_cLeon.BP_PlayerController_cLeon_C.hide
// (BlueprintCallable, BlueprintEvent)

void ABP_PlayerController_cLeon_C::hide()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PlayerController_cLeon_C", "hide");
