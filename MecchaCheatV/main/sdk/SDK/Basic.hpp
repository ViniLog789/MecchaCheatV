...
namespace Offsets
{
	constexpr int32 GObjects          = 0x097485A0;
	constexpr int32 AppendString      = 0x01395580;
	constexpr int32 GNames            = 0x098ED600;
	constexpr int32 GWorld            = 0x0977F270;
	constexpr int32 ProcessEvent      = 0x015B3280;
