...
namespace Offsets
{
	constexpr int32 GObjects          = 0x097DE5A0;
	constexpr int32 AppendString      = 0x013958C0;
	constexpr int32 GNames            = 0x09983780;
	constexpr int32 GWorld            = 0x09815270;
	constexpr int32 ProcessEvent      = 0x015B3430;
