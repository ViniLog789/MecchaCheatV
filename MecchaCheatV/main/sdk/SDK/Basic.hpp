...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09F427D0;
	constexpr int32 AppendString      = 0x013B3310;
	constexpr int32 GNames            = 0x09E26178;
	constexpr int32 GWorld            = 0x09C8B620;
	constexpr int32 ProcessEvent      = 0x015D0B50;
