...
namespace Offsets
{
	constexpr int32 GObjects          = 0x096FD5A0;
	constexpr int32 AppendString      = 0x01394EF0;
	constexpr int32 GNames            = 0x098A1C00;
	constexpr int32 GWorld            = 0x09734270;
	constexpr int32 ProcessEvent      = 0x015B28C0;
