...
namespace Offsets
{
	constexpr int32 GObjects          = 0x097095A0;
	constexpr int32 AppendString      = 0x013940D0;
	constexpr int32 GNames            = 0x098AEB80;
	constexpr int32 GWorld            = 0x09740270;
	constexpr int32 ProcessEvent      = 0x015B1AA0;
