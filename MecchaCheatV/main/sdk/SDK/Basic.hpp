...
namespace Offsets
{
	constexpr int32 GObjects          = 0x097445A0;
	constexpr int32 AppendString      = 0x013954E0;
	constexpr int32 GNames            = 0x098E9780;
	constexpr int32 GWorld            = 0x0977B270;
	constexpr int32 ProcessEvent      = 0x015B3050;
