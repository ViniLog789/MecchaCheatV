...
// Enum OnlineSubsystemBlueprints.EOnlineServerConnectionStatus_BP
// NumValues: 0x000D
enum class EOnlineServerConnectionStatus_BP : uint8
{
	Normal                                   = 0,
	NotConnected                             = 1,
	Connected                                = 2,
	...
	UpdateRequired                           = 6,
	ServersTooBusy                           = 7,
	DuplicateLoginDetected                   = 8,
	InvalidUser                              = 9,
	NotAuthorized                            = 10,
	InvalidSession                           = 11,
	EOnlineServerConnectionStatus_MAX        = 12,
};
