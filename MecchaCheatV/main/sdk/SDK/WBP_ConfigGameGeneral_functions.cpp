...
// Function WBP_ConfigGameGeneral.WBP_ConfigGameGeneral_C.GetRootFocusTarget
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UWidget**                         Widget                                                 (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UWBP_ConfigGameGeneral_C::GetRootFocusTarget(class UWidget** Widget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ConfigGameGeneral_C", "GetRootFocusTarget");

	Params::WBP_ConfigGameGeneral_C_GetRootFocusTarget Parms{};
