...
{
public:
	struct FLiveLinkSubjectPreset                 SubjectPreset;                                     // 0x0108(0x0038)(NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	...
	class FName                                   SubjectName;                                       // 0x0170(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLiveLinkFrameData                     TemplateToPush;                                    // 0x0178(0x0090)(Deprecated, NativeAccessSpecifierPublic)
	struct FLiveLinkRefSkeleton                   RefSkeleton;                                       // 0x0208(0x0020)(Deprecated, NativeAccessSpecifierPublic)
	TArray<class FName>                           CurveNames;                                        // 0x0228(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	TArray<struct FMovieSceneFloatChannel>        PropertyFloatChannels;                             // 0x0238(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
...
public:
	...
	TSubclassOf<class ULiveLinkRole>              TrackRole;                                         // 0x0148(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
